...
hand_scan = "../../userScans/mercy_right_hand.stl"; //location of STL of patient's hand scan

hand_d = 38; //diameter of the thickest part of the patient's hand in mm
hand_pos = [17,5,-220]; //position of the hand in X,Y,Z axis so that the palm is centered on the Z axis and aligned with the thumb piece in preview.scad
hand_rot = [-5,4,-90]; //rotation of hand scan about each axis so that the patient's finger(s) oppose the thumb post in preview.scad
